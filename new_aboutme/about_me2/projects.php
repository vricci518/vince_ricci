...
<head>
	...
	<title>Vincent Ricci Jr - Knitting Projects</title>
</head>
...
<body>
	...
	<div class="album py-5">
		<div class="container">
			...
			<p>Here are examples of some of my favorite Hand-Knit projects. Each has a link to the project page that is housed on Ravelry.com. Those links will each open in a new page.</p>
			<div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 g-3">
				<div class="col">
					<div class="card shadow-sm">
						<img src="img/icelandic.jpg" class="card-img-top" alt="icelandic sweater">
						<div class="card-body">
							<h3 class="card-title">Icelandic Sweater 2020</h3>
				...
				<div class="col">
					<div class="card shadow-sm">
						<img src="img/berniemittens.jpg" class="card-img-top" alt="bernie mittens">
						<div class="card-body">
							<h3 class="card-title">Bernie Mittens</h3>
				...
				<div class="col">
					<div class="card shadow-sm">
						<img src="img/wallaby.jpg" class="card-img-top" alt="wallaby hoodie">
						<div class="card-body">
							<h3 class="card-title">Wallaby Hoodie</h3>
				...
				<div class="col">
					<div class="card shadow-sm">
						<img src="img/guelph.jpg" class="card-img-top" alt="guelph lace shawl">
						<div class="card-body">
							<h3 class="card-title">Guelph Lace Shawl</h3>
				...
				<div class="col">
					<div class="card shadow-sm">
						<img src="img/strandwanderer.jpg" class="card-img-top" alt="strandwanderer shawl">
						<div class="card-body">
							<h3 class="card-title">Strandwanderer</h3>
				...
				<div class="col">
					<div class="card shadow-sm">
						<img src="img/schoolspirit.jpg" class="card-img-top" alt="school spirit cardigan">
						<div class="card-body">
							<h3 class="card-title">School Spirit Cardigan</h3>
